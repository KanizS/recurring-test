...
function onDateSelect(date){
  ...
  console.log(date); 
  jQuery.post('/cart/update.js', {"attributes":{"streamthing_delivery_date":date}, "tags": "new-tag"});

};

function onAreaSelect(formInputTarget,towns){


  jQ( 'select[id=select_town]' ).change(function() {
    
    var town = this.value;
    var disabledDates = [0,1,2,3,4,5,6];
    
    for(var i=0, len=towns[town][1].length; i < len; i++){
      var index = disabledDates.indexOf(towns[town][1][i]);
      disabledDates.splice(index,1);
    }
    jQ('#' + formInputTarget).datetimepicker('destroy');
    window.options.daysOfWeekDisabled = disabledDates;
    jQ('#' + formInputTarget).datetimepicker(window.options);
...
(function () {
  ...
  var towns = { 
    ...
    'Rathmalana' : ['Rathmalana ', [2]],
    'Moratuwa' : ['Moratuwa ', [2]],
    'Kadawatha' : ['Kadawatha ', [3]],
    'Kiribathgoda' : ['Kiribathgoda ', [3]],
    'Keleniya'	:	['Keleniya'	,	[3]],
    'Wattala'	:	['Wattala'	,	[3]],
    'Athurugiriya'	:	['Athurugiriya'	,	[5]],
    'Papiliyana Nugegoda'	:	['Papiliyana Nugegoda'	,	[2]],
    'Boralasgamuwa'	:	['Boralasgamuwa'	,	[2]],
    'Hokandara'	:	['Hokandara'	,	[2]],
    'Kaduwela'	:	['Kaduwela'	,	[2,5]],
    'Koswatta - Battaramulla '	:	['Koswatta - Battaramulla '	,	[5]],
    'Colombo 7'	:	['Colombo 7'	,	[2,5]],
    'Ethul Kotte'	:	['Ethul Kotte'	,	[5]],
    'Pelawatta	':	['Pelawatta'	,	[2,5]],
    'Nawala'	:	['Nawala'	,	[5]],
    'Kotte'	:	['Kotte'	,	[5]],
    'Nugegoda'	:	['Nugegoda'	,	[5]],
    'Malabe'	:	['Malabe'	,	[2,5]],
    'Saturday Good Market - Race Course Colombo'	:	['Saturday Good Market - Race Course Colombo'	,	[6]],
    'Colombo 4 (Bambalapitiya)'	:	['Colombo 4 (Bambalapitiya)'	,	[2]],
    'Colombo 5'	:	['Colombo 5'	,	[5]],
    'Colombo 2' :	['Colombo 2	',	[5]],
    'Colombo 8'	:	['Colombo 8'	,	[5]],
    'Rajagiriya':	['Rajagiriya'	,	[2,5]],
    'Battaramulla'	:	['Battaramulla'	,	[2,5]],
    'Retail Shop Colombo 07'	:	['Retail Shop Colombo 07'	,	[2,5]],
    'Pannipitiya'	:	['Pannipitiya'	,	[2]],
    'Wellawatta (Colombo 06)'	:	['Wellawatta (Colombo 06)'	,	[2]],
    'Mt-laviniya'	:	['Mt-laviniya'	,	[2]],
    'Thalawathugoda'	:	['Thalawathugoda'	,	[2,5]],
    'Dehiwala'	:	['Dehiwala'	,	[2]],
    'Colombo 3' :	['Colombo 3	',	[2,5]]
  ...
  onAreaSelect(formInputTarget,towns);
  ...
  function applySettings(settings, callback){
    ...
    window.options = datetimepickerOptions;
...
<input onblur=onDateSelect(this.value); class='form-control datetimepicker-input' type='text' data-target='#" + formInputTarget + "' name='deleverydate' id='" + formInputTarget + "_input" + "' value='{{ cart.attributes." + formInputTarget + " }}' />\
...
";
    ...
    var datePicker = "\
        ...
        <input onblur=onDateSelect(this.value); class='form-control datetimepicker-input' type='text' data-target='#" + formInputTarget + "' name='attributes[" + formInputTarget + "]' id='" + formInputTarget + "_input" + "' value='{{ cart.attributes." + formInputTarget + " }}' />\
